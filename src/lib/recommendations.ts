...
/**
 * @fileoverview This file contains curated lists of recommended courses and videos for various career fields.
 * This data is used by the AI flows to provide relevant recommendations to users.
 */
